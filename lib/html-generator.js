...
const getTemplateStructure = (
    ...
    .map(([platform, url]) => {
      ...
      switch (templateId) {
        ...
        case "tech-aura":
          ...
          break
        case "creative":
          templateClasses = "text-purple-600 dark:text-purple-400 hover:text-pink-600 dark:hover:text-pink-400"
          break
        case "modern":
          templateClasses =
            "w-10 h-10 flex items-center justify-center rounded-full bg-white dark:bg-gray-800 shadow-md text-emerald-600 dark:text-emerald-400 hover:bg-emerald-600 hover:text-white dark:hover:bg-emerald-600"
          break
        case "professional":
          templateClasses = "text-blue-600 dark:text-blue-400 hover:text-indigo-600 dark:hover:text-indigo-400"
          break
        case "dark":
          templateClasses = "text-gray-400 hover:text-white"
          break
        default:
    ...
    .map((skill, index) => {
      ...
      switch (templateId) {
        ...
        case "tech-aura":
          ...
          `
        case "creative":
          skillClass = "px-4 py-2 bg-white dark:bg-gray-800 rounded-full shadow-sm"
          break
        case "modern":
          skillClass = "bg-white dark:bg-gray-800 rounded-lg p-3 shadow-sm hover:shadow-md"
          break
        case "professional":
          skillClass = "px-3 py-1 bg-gray-100 dark:bg-gray-800 rounded-md text-sm"
          break
        case "dark":
          skillClass = "px-3 py-1 bg-gray-800 rounded-md"
          break
        default:
    ...
    .map((project, index) => {
      ...
      switch (templateId) {
        ...
        case "tech-aura":
          ...
          break
        case "creative":
          projectClass = "bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg"
          titleClass = "text-xl font-bold mb-3"
          descClass = "text-gray-700 dark:text-gray-300 mb-4"
          linkClass =
            "inline-flex items-center gap-1 text-purple-600 dark:text-purple-400 hover:text-pink-600 dark:hover:text-pink-400 font-medium"
          break
        case "modern":
          projectClass = "bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg"
          titleClass = "text-xl font-bold mb-2"
          descClass = "text-gray-700 dark:text-gray-300 mb-4 line-clamp-3"
          linkClass =
            "inline-flex items-center gap-1 text-emerald-600 dark:text-emerald-400 hover:text-teal-700 dark:hover:text-teal-300 font-medium"
          break
        case "professional":
          projectClass = "bg-gray-50 dark:bg-gray-800/50 rounded-lg overflow-hidden shadow-sm hover:shadow-md"
          titleClass = "text-xl font-semibold mb-2"
          descClass = "text-gray-700 dark:text-gray-300 mb-4"
          linkClass =
            "inline-flex items-center gap-1 text-blue-600 dark:text-blue-400 hover:text-indigo-600 dark:hover:text-indigo-400 font-medium"
          break
        case "dark":
          projectClass = "bg-gray-800 rounded-lg overflow-hidden"
          titleClass = "text-xl font-semibold text-white mb-2"
          descClass = "text-gray-400 mb-4"
          linkClass = "inline-flex items-center gap-1 text-blue-400 hover:text-blue-300"
          break
        default:
  ...
  const templates = {
      ...
      <div class="max-w-5xl mx-auto px-6 py-16">
        <header class="flex flex-col md:flex-row items-center md:items-start gap-8 mb-16">
          ...
          <div class="text-center md:text-left">
            <h1 class="text-3xl md:text-4xl font-bold mb-2">${personalInfo.name}</h1>
            <h2 class="text-xl text-gray-600 dark:text-gray-400 mb-4">${personalInfo.title}</h2>
            <p class="max-w-2xl text-gray-700 dark:text-gray-300 mb-6">${personalInfo.bio}</p>
        ...
        <section class="mb-16 animate-on-scroll">
          <h2 class="text-2xl font-bold mb-6 pb-2 border-b border-gray-200 dark:border-gray-700">Skills</h2>
        ...
        <section class="animate-on-scroll">
          <h2 class="text-2xl font-bold mb-6 pb-2 border-b border-gray-200 dark:border-gray-700">Projects</h2>
    ...
    creative: `
      <header class="min-h-[70vh] flex flex-col items-center justify-center text-center px-6 py-16">
        ${
          profileImage
            ? `<div class="profile-image w-40 h-40 rounded-full overflow-hidden border-4 border-white dark:border-gray-800 shadow-xl mb-8">
            <img src="${profileImage}" alt="${personalInfo.name}" class="w-full h-full object-cover">
          </div>`
            : ""
        }
        
        <div class="header-content max-w-2xl mx-auto">
          <h1 class="text-4xl md:text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-400 dark:to-pink-400">
            ${personalInfo.name}
          </h1>
          <h2 class="text-xl md:text-2xl text-gray-600 dark:text-gray-400 mb-6">${personalInfo.title}</h2>
          <p class="text-lg text-gray-700 dark:text-gray-300 mb-8">${personalInfo.bio}</p>
      ...
      <main class="max-w-5xl mx-auto px-6 pb-16">
        <section class="mb-16 animate-on-scroll">
          <h2 class="text-2xl font-bold mb-8 text-center bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-400 dark:to-pink-400">
            My Skills
          </h2>
    ...
    professional: `
      <header class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border-b border-gray-200 dark:border-gray-800">
        <div class="max-w-5xl mx-auto px-6 py-12">
          <div class="flex flex-col md:flex-row items-center md:items-start gap-8">
            ${
              profileImage
                ? `<div class="w-32 h-32 rounded-full overflow-hidden border-4 border-white dark:border-gray-800 shadow-md">
                <img src="${profileImage}" alt="${personalInfo.name}" class="w-full h-full object-cover">
              </div>`
                : ""
            }
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="md:col-span-1">
            <section class="mb-8 animate-on-scroll">
              <h2 class="text-xl font-bold mb-4 pb-2 border-b border-gray-200 dark:border-gray-800">Skills</h2>
              <div class="flex flex-wrap gap-2">
                ${skillsHTML}
              </div>
            </section>
            ...
            <section class="animate-on-scroll">
              <h2 class="text-xl font-bold mb-4 pb-2 border-b border-gray-200 dark:border-gray-800">Contact</h2>
              <div class="space-y-3">
                ${socialLinksHTML}
              </div>
            </section>
          ...
          <div class="md:col-span-2">
            <section class="animate-on-scroll">
              <h2 class="text-2xl font-bold mb-6 pb-2 border-b border-gray-200 dark:border-gray-800">Projects</h2>
              <div class="space-y-8">
                ${projectsHTML}
              </div>
            </section>
      ...
      <div class="max-w-6xl mx-auto px-6 py-16">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-8 mb-16">
          <div class="md:col-span-5 flex flex-col items-center md:items-start">
            ${
              profileImage
                ? `<div class="profile-image w-40 h-40 rounded-2xl overflow-hidden shadow-lg mb-6">
                <img src="${profileImage}" alt="${personalInfo.name}" class="w-full h-full object-cover">
              </div>`
                : ""
            }
            ...
            <div class="text-center md:text-left">
              <h1 class="text-3xl md:text-4xl font-bold mb-2">${personalInfo.name}</h1>
              <h2 class="text-xl text-emerald-600 dark:text-emerald-400 mb-6">${personalInfo.title}</h2>
              <p class="text-gray-700 dark:text-gray-300 mb-8 max-w-md">${personalInfo.bio}</p>
          ...
          <div class="md:col-span-7 animate-on-scroll">
    ...
    dark: `
      <div class="max-w-5xl mx-auto px-6 py-16">
        <header class="flex flex-col md:flex-row items-center md:items-start gap-8 mb-16">
          ${
            profileImage
              ? `<div class="w-36 h-36 rounded-full overflow-hidden border-2 border-gray-700">
              <img src="${profileImage}" alt="${personalInfo.name}" class="w-full h-full object-cover">
            </div>`
              : ""
          }
          ...
          <div class="text-center md:text-left">
            <h1 class="text-3xl md:text-4xl font-bold text-white mb-2">${personalInfo.name}</h1>
            <h2 class="text-xl text-gray-400 mb-6">${personalInfo.title}</h2>
            <p class="text-gray-400 mb-8 max-w-2xl">${personalInfo.bio}</p>
        ...
        <section class="mb-16 animate-on-scroll">
          <h2 class="text-2xl font-bold text-white mb-6 pb-2 border-b border-gray-800">Skills</h2>
          <div class="flex flex-wrap gap-2">
            ${skillsHTML}
          </div>
        </section>
        ...
        <section class="animate-on-scroll">
          <h2 class="text-2xl font-bold text-white mb-6 pb-2 border-b border-gray-800">Projects</h2>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ${projectsHTML}
          </div>
        </section>
      ...
      <section id="home" class="min-h-screen flex items-center">
        <div class="max-w-6xl mx-auto px-6 py-24 md:py-32 w-full">
          <div class="text-center md:text-left">
            ...
            <p class="text-gray-600 mb-12 max-w-xl mx-auto md:mx-0">${personalInfo.bio}</p>
            <div class="flex flex-wrap gap-4 justify-center md:justify-start">

      ...
      <div className="min-h-screen flex flex-col justify-center items-center px-4 text-gray-100 relative z-10">
        ...
        >
          {[
            ...
            { icon: <Users className="mx-auto h-12 w-12 text-purple-400" />, title: "Community Support", description: "Join a vibrant community to get the best tips and advice." },
        ...
        >
          ...
          <div className="flex flex-col md:flex-row justify-center gap-10">
            {[
              {
                quote: "“PortaCraft made my portfolio in 5 minutes. The animations are fire!”",
        ...
        >
          <p>© {new Date().getFullYear()} PortaCraft. All rights reserved.</p>
        </footer>
      </div>
    </>
  )
